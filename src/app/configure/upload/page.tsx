        ...
        >
          {({ getRootProps, getInputProps }) => (
            ...
            >
                ...
                {isUploading ? (
                  <div className="flex flex-col items-center">
                    ...
                    <Progress
                      ...
                      className="
                    mt-2 h-2 w-40 bg-gray-300"
                    />
                  </div>
                ) : isPending ? (
                  <div className=" mt-2 h-2 w-40 bg-gray-300">
                    <p>Redirecting... Please wait</p>
                  </div>
                ) : isDragOver ? (
                  <p>
                    <div className="font-semibold"> Drag file </div>
                    to upload
                  </p>
                ) : (
                  <p>
              ...
              {isPending ? null : (
                <p className="text-xs text-zinc-500"> JPG, JPEG, PNG</p>
              )}
            </div>
          )}
        </Dropzone>
